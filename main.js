...
Orb.prototype.update = function () {
    ...
    //attempt to make the lightning only shoot off
    //when the game time is at a certain interval
    //
    //

    if (this.newLightningStrikeCounter >= 3.75 && this.orbNumber == '9'
                                              && this.game.entities[0].gameOver == false) {
        this.readyToStrike = true;
    } else if (this.orbNumber == '9' && this.game.entities[0].gameOver == false) {
